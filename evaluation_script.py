...
def plot_presentation():
    ...
    file_name = 'cam1cam5_intra_0_0.2_0.4__ly4ftr16w2__cam1_161007_0_0.2_0.4.csv'
    ...
    bw_opt_sens = dict(n_support=30, min_support=40, max_support=400, ici_span=4.4, rel_threshold=0.85, irls=False)
    ...
    qse_sofi.present_plot(res_sofi, res_sens)

    # calculate difference
    coeff_nr = 3
    prim_nr = 4
    sig_sens = res_sens[550:1530, 1]
    sig_sofi = res_sofi[550:1530, 1]
    feat_sens = res_sens[550:1530, 1 + 2 * coeff_nr + prim_nr:2 * coeff_nr + 2 * prim_nr + 1]
    feat_sofi = res_sofi[550:1530, 1 + 2 * coeff_nr + prim_nr:2 * coeff_nr + 2 * prim_nr + 1]
